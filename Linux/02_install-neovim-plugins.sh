...
curl -fLo "${HOME}/.local/share/nvim/site/autoload/plug.vim" "https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim" || echo_error "Error downloading vim-plug"
...
nvim -c "e ${NEWTMP}" -c "PlugInstall" || echo_error "Error Installing Plugins in nvim"
