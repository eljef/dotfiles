...
echo "dircolors -b \"${FILES_PATH}/Dracula_Inspired.dircolors\" > \"${HOME}/.bash_exports/export_ls_colors\""
dircolors -b "${FILES_PATH}/Dracula_Inspired.dircolors" > "${HOME}/.bash_exports/export_ls_colors"
