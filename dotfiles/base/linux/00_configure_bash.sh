...
del_file "${HOME}/.base_exports/alias_grep.sh"
del_file "${HOME}/.base_exports/alias_ls.sh"
del_file "${HOME}/.base_exports/alias_vim.sh"
del_file "${HOME}/.base_exports/export_editor.sh"
del_file "${HOME}/.base_exports/export_ps1.sh"
del_file "${HOME}/.base_exports/export_visual.sh"
...
install_file 0644 "${FILES_PATH}/bash_exports/export_ps1.sh" "${HOME}/.bash_exports/export_ps1"
